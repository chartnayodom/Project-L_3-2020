...
<tbody>
                ...
                foreach($row as $user)
                {
                    ?>
                <tr>
                    <td><?php echo $user['id_dash'];?></td>
                    <td><?php echo $user['name_dash'];?></td>
                    <td><?php echo $user['email_dash'];?></td>
                    <td><?php echo $user['gender_dash'];?></td>
                    <td><?php echo $user['status_dash'];?></td>
                    <td>
                        <form action="delete.php" method="POST">
                        
                        <button onclick="myFunction()" name="delete" value = "<?php echo $user['id_dash'];?>"  class="btn btn-danger">
                      <!--icon-->
