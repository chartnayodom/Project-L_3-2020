      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <button type="button" class="btn btn-sm btn-outline-secondary"><a href = "addproduct2.php">Add</a></button>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $user['name_pro'];?></td>
                    <td><?php echo $user['code'];?></td>
                    <td><?php echo $user['price_pro'];?></td>
                    <td><?php echo $user['category_pro'];?></td>
                    <td><img src="image/<?php echo $user['fileupload'];?>" width='100'></td>
                    <td>
                        <form action="deletepro.php" method="POST">
                        
                        <button onclick="myFunction()" name="delete" value = "<?php echo $user['id_pro'];?>"  class="btn btn-danger">
                      <!--icon-->
                      ...
                      <td>
                        ...
                        <button name="edit" value = "<?php echo $user['id_pro'];?>"  class="btn btn-primary">แก้ไข</button>
                        </form>
                    </td>
               <?php 
               }
