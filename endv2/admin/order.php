...
<link href="../assets/dist/css/bootstrap.css" rel="stylesheet">
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow" style="background-color:#CAE1EF;">
...
<div class="container-fluid d-flex justify-content-between">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive" style="align:right;">
        <table class="table table-striped table-sm" style="width:100%">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td><?php echo $pur['id_order'];?></td>
                <td><?php echo $pur['username'];?></td>
                <td><?php echo $pur['name'];?></td>
                <td><?php echo $pur['phone'];?></td>
                <td><?php echo $pur['date_order'];?></td>
                <td><?php echo $pur['total'];?></td>
                <td><?php echo $pur['paymentstatus'];?></td>
                <td>
