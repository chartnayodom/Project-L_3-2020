<?php
 ...
 session_start();
 $uid = $_POST['edit'];
 $sql2 = "SELECT * FROM `tb_product` WHERE id_pro = '$uid'";
...
<div class="container-md mx-auto my-5">
      <h1>Edit Product</h1>
    <form class="form" action="editpro.php" method="post" enctype="multipart/form-data" id="AddressForm">
       
        <div class="form-group">
            <div class="col-md-6 mx-auto">
              <label for="name_pro"><h4>Name product</h4></label>
              <input type="text" class="form-control" name="name_pro" id="name_pro"  value="<?php echo $name;?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="price_pro" id="price_pro"  value="<?php echo $price;?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="category_pro" id="category_pro" value="<?php echo $category;?>">
            </div>
        </div>
        ...
        <div class="form-group">
             <div class="col-md-12 mx-auto">
                  <br>
                    ...
                    <button class="btn btn-lg btn-success" type="submit" value = "<?php echo $uid;?>" name = "edit"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
