<?php
 ...
 $sql = "SELECT U_ID FROM `useraddress` WHERE U_ID = '$uid' LIMIT 1" ;
  ...
  //Check ข้อมูลว่ามีเกิน 1 recordมั้ย
    ...
    //ค้นหาRecord addressของUser แล้วตั้งตัวแปร
    $sql2 = "SELECT * FROM `useraddress` WHERE U_ID = '$uid'";
...
<body  img src="img/hallo.jpg">
    ...
    <form class="form" action="addr_edit.php" method="post" id="AddressForm">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="mobile" id="mobile"  value="<?php echo $phone;?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="location" id="location"  value="<?php echo $Address;?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="postcode" id="postcode"  value="<?php echo $post;?>">
            </div>
        </div>
