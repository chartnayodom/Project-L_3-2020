...
<body>
    <!--Navbar เมนูบาร์-->
        ...
        <div>   
        <ul class="navbar-nav">
        <a href="#"><i class="fa fa-facebook-square" style="font-size:35px"></i></a>
        &nbsp;&nbsp;
        <li><a href="cart.php" ><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-basket" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            &nbsp;&nbsp;
            <li><a href="login.php"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
