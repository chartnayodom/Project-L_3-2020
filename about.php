                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-7">
                         <div class="personal_text">
                             ...
                             <h3>Wut-Service</h3>
                             <p>คุณมีปัญหาเกี่ยวกับแล็บท็อป หรือ คอมพิวเตอร์ ? สามารถติดทางเราได้เลยครับ
                             อยากได้คอมพิวเตอร์ประกอบ ราคาประหยัด หรือไม่ ?สามารถติดทางเราได้เลยครับ</p>

                             <ul class="list basic_info">
                                 <li><a href="#"><i class="lnr lnr-phone-handset"></i>091 819 3226</a></li>
                                 <li><a href="https://www.facebook.com/WutServiceZeer/"><i class="fa fa-facebook"></i>WutServiceZeer</a></li>
                                 <li><a href="#"><i class="lnr lnr-home"></i>ชั้น 3 เซียร์ ห้อง TB 086</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">คุณมีปัญหาเกี่ยวกับแล็บท็อป หรือ คอมพิวเตอร์ ? สามารถติดทางเราได้เลยครับ อยากได้คอมพิวเตอร์ประกอบ ราคาประหยัด หรือไม่ ?สามารถติดทางเราได้เลยครับ</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834132/avatar-4_ozhrib.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          ...
          <ul class="social mb-0 list-inline mt-3">
            <li class="list-inline-item"><a href="#" class="social-link"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
